...
# Pointing to the augmented features directory from Step V3-B
...
EPOCHS = 80
PATIENCE = 20
LEARNING_RATE = 0.0003  # Slightly lower to prevent early overfitting
NUM_CLASSES = 8
...
# ============================================================
# 5. Regularized 1D CNN Architecture
# ============================================================
class RegularizedEmotionCNN(nn.Module):
    def __init__(self, in_channels=39, num_classes=8, dropout=0.35):
        super().__init__()
        ...
        self.block3 = nn.Sequential(
            ...
            nn.BatchNorm1d(256),
            nn.ReLU(),
            nn.AdaptiveAvgPool1d(1),  # Temporal Global Average Pooling
...
model = RegularizedEmotionCNN().to(device)

# Class weights for neutral class imbalance
...
# ============================================================
# 6. Train / Validation Epoch Function
# ============================================================
...
# ============================================================
# 7. Training Loop (Validation Accuracy Checkpointing)
# ============================================================
best_val_acc = 0.0
patience_counter = 0
best_model_path = MODELS_DIR / "best_speech_emotion_v3b.pth"

print("\nStarting Training V3-B...")
...
for epoch in range(EPOCHS):
    ...
    # Scheduler adjusts learning rate based on val_loss
    ...
    # Checkpoint saved strictly when Validation Accuracy improves
    if val_acc > best_val_acc:
        best_val_acc = val_acc
        patience_counter = 0
        torch.save(model.state_dict(), best_model_path)
        print(f"  → Best V3-B checkpoint saved! (New Best Val Acc: {best_val_acc:.4f})")
    else:
        patience_counter += 1
...
# ============================================================
# 8. Evaluate on Unseen Test Speakers (Actors 21-24)
# ============================================================
...
print(f"\n--- V3-B Final Test Results ---\nTest Accuracy: {test_acc:.4f} | Test F1: {test_f1:.4f}")
print("\nClassification Report:")
print(classification_report(y_true, y_pred, target_names=CLASS_NAMES, digits=4))

# Save Confusion Matrix
cm = confusion_matrix(y_true, y_pred)
np.savetxt(RESULTS_DIR / "confusion_matrix_v3b.csv", cm, delimiter=",", fmt="%d")
print("V3-B test evaluation complete.")